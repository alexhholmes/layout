...
import (
	...
	"layout/internal/parser"
)

// Generator generates marshal/unmarshal code for binary layouts
type Generator struct {
	analyzed *analyzer2.AnalyzedLayout
	registry *analyzer2.TypeRegistry
	endian   string // "little" or "big"
}

// NewGenerator creates a new code generator
func NewGenerator(analyzed *analyzer2.AnalyzedLayout, reg *analyzer2.TypeRegistry, endian string) *Generator {
	if endian == "" {
		endian = "little"
	}
	return &Generator{
...
func (g *Generator) Generate() (string, error) {
	...
	// Package comment
	out.WriteString("// Code generated by layoutgen. DO NOT EDIT.\n\n")
...
func (g *Generator) GenerateMarshal() string {
	...
	for _, region := range g.analyzed.Regions {
		if region.Kind == analyzer2.FixedRegion {
...
func (g *Generator) generateFixedMarshal(region analyzer2.Region) string {
	var code strings.Builder
...
func (g *Generator) generateFixedUnmarshal(region analyzer2.Region) string {
	var code strings.Builder
...
func (g *Generator) generateDynamicMarshal(region analyzer2.Region) string {
	var code strings.Builder
...
func (g *Generator) generateDynamicUnmarshal(region analyzer2.Region) string {
	var code strings.Builder
